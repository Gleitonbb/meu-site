...
function Acessorios() {
  ...
  useEffect(() => {
    const carregarProdutos = async () => {
      try {
        ...
        const apenasAcessorios = dados.filter(p => p.categoria === 'Acessórios');
        setProdutos(apenasAcessorios);
      } catch (error) {
        console.error("Erro ao integrar com o Banco de Dados no setor de acessórios:", error);
      } finally {
        setCarregando(false);
      }
    };
  ...
  const confirmarPagamentoFinal = async (e) => {
    ...
    try {
      ...
      console.error("Erro na integração do pagamento de acessórios:", error);
  ...
  return (
    <div className="pagina-acessorios">
      ...
      <header className="acessorios-header">
        <h2>Acessórios Premium</h2>
        <p>O detalhe que transforma o seu visual com elegância e personalidade</p>
      </header>

      {carregando && <p className="status-texto">Carregando acessórios do banco de dados...</p>}

      {!carregando && produtos.length === 0 && (
        <p className="status-texto">Nenhum produto cadastrado na categoria Acessórios.</p>
      )}
            ...
            <div className="modal-layout-flex">
              ...
              <div className="carrossel-container">
                ...
                {produtoSelecionado.imagens && produtoSelecionado.imagens.length > 0 ? (
                  <img src={produtoSelecionado.imagens[fotoAtual]} alt="Foto do acessório" className="imagem-carrossel" />
                ) : (
              ...
              <div className="modal-detalhes-compra">
                ...
                <p className="modal-descricao">
                  {produtoSelecionado.descricao || "Produto de alta qualidade, acabamento impecável. Perfeito para compor o seu estilo no dia a dia."}
                </p>

                {tamanhosDisponiveis.length > 0 && (
                  <div className="seletor-atributo">
                    <h4>Selecione o Tamanho / Medida:</h4>
